...
export default function Footer() {
  return (
    <>
      <div className="fixed left-5 landscape:left-10 bottom-9 z-[2] font-ibm font-light uppercase text-[9px] landscape:text-[11px] tracking-footer text-wisteria-600" />

      <div className="fixed right-5 landscape:right-10 bottom-9 z-[2] font-ibm font-light uppercase text-[9px] landscape:text-[11px] tracking-footer text-wisteria-600">
        <a
